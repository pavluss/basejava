<%@ page import="ru.saparsky.basejava.model.ContactType" %>
<%@ page import="ru.saparsky.basejava.model.SectionType" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="ru.saparsky.basejava.model.Organization.Position"/>
                                <dl>
